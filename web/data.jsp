...
<html>
        ...
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <div class="border-head">
              <h3>Traveaux Pratiques de Data Science et Cloud computing</h3>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="product-panel-2 pn">
                  ...
                  <div><a  href="r.html"><button class="btn btn-small btn-theme04">play</button></a></div>
                </div>
              </div>
  ...
  <div class="col-lg-3 ds">
            ...
            <div class="donut-main">
                ...
                <img src="img/logodata.png" class="d-block " height="160" width="100%" >
            </div>
           <div class="donut-main">
